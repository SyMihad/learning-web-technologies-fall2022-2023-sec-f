    ...
    <body>
            ...
            <fieldset>
                ...
                <table align="center" height="700px" width="700px"  border="1">
                    <tr><td align="center"><h1>Select Food Item</h1></td></tr>
                    <tr><td><hr></td></tr>
                   ...
                   <?php
                    ...
                    <tr>
                        ...
                        <td align="top">
                            <form method="post" action="guestOrderConfirm.php" enctype="">
                                <table border="1">
                                    <tr>
                                        <td><b>Food Name</b></td>
                                        <td><b>Price</b></td>
                                    ...
                                    <tr>
                                        <td colspan="3"><b>Name=</b> <input type='text' name='guestName' value=''></td>
                                    </tr>
                    ...
                    <tr align="center">
                        <td colspan="2"><a href="home.php"><p  style="color:red; font-size:20px;"><b>Log Out<b></p></a></td>
                    </tr>
