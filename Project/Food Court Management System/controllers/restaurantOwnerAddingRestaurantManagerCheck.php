<?php
    ...
    header('location: restaurantOwnerAddManager.php?err==passNotMatch');
    }
    else if($firstName=="" or $lastName=="" or $userName=="" or $restaurantName=="" or $email=="" or $phone=="" or $password=="" or $confirmPassword==""){
    header('location: restaurantOwnerAddManager.php?err=null');
    }
    else{
        ...
        if(move_uploaded_file($src, $des)){
            header('location: restaurantOwnerAddManager.php');
        }
        else{
            header('location: restaurantOwnerAddManager.php?message=Manager_pic_setting_failed');
        }
